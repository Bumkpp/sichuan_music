    ...
    <el-card class="box-card">
      ...
      >
        ...
        <el-row :gutter="20">
          ...
          <el-col :span="12">
            <el-form-item label="参赛类别：" prop="pro_type">
              <el-select
        ...
        <el-form-item label="视频上传：" prop="pro_url">
          <el-upload
            action
            :http-request="Upload"
        ...
        >
          ...
          <el-row :gutter="16">
            ...
            <el-col :span="2">
              <el-button type="text" @click="uploadT">下载模板</el-button>
            </el-col>
            <el-col :span="2">
              <el-button
                type="text"
        ...
        >
          ...
          <el-row :gutter="12">
            ...
            <el-col :span="2">
              <el-button type="text" @click="uploadT1">下载模板</el-button>
            </el-col>
            <el-col :span="2">
              <el-button
                type="text"
        ...
        >
          ...
          <el-row :gutter="12">
            ...
            <el-col :span="2">
              <el-button type="text" @click="uploadT2">下载模板</el-button>
            </el-col>
            <el-col :span="2">
              <el-button
                type="text"
...
import { modifyTable } from "./../http/panel";
  ...
  methods: {
    async getDetail() {
      ...
      if (data.code == 200) {
        ...
        for(let i=0; i<this.form.teacher.length; i++) {
            delete this.form.teacher[i].pro_id
        }
        for(let i=0; i<this.form.studen.length; i++) {
            delete this.form.studen[i].pro_id
        }
        for(let i=0; i<this.form.stu.length; i++) {
            delete this.form.stu[i].pro_id
        }
    ...
    submitForm() {
      toRaw(this.$refs.formRef.validate)(async (valid) => {
        ...
        const data = await modifyTable(value).catch(handleError);
        if (data.code == 200) {
      ...
      async function multipartUpload() {
        ...
        client(that.dataObj)
          ...
          .then((result) => {
            ...
            that.form.pro_url = r;
            // window.sessionStorage.setItem("urls", result.res.requestUrls);
          })
          .catch((err) => {
            console.log("err:", err);
          });
